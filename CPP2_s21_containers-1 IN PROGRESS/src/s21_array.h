...
// --------------------------ARRAY-CLASS-ITERATOR------------------------------------------------------------------------------//  
    class arr_iterator{
        ...
        public:
            ...
            arr_iterator operator--() {return --pos_;}
            arr_iterator operator++(int) const {return pos_++;}
            arr_iterator operator--(int) const {return pos_--;}
            int operator-(const arr_iterator &other) {return pos_ - other.pos_;}
            reference operator*()  {return *pos_;}
            bool operator==(arr_iterator &other) {return pos_ == other.pos_;}
            bool operator!=(arr_iterator &other)  const { return pos_ != other.pos_;}
